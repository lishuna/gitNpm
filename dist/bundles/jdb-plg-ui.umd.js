(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/animations'), require('@angular/forms'), require('rxjs/Observable'), require('@angular/platform-browser'), require('ng2-cookies/ng2-cookies'), require('rxjs/Rx'), require('@angular/router'), require('@angular/common')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/animations', '@angular/forms', 'rxjs/Observable', '@angular/platform-browser', 'ng2-cookies/ng2-cookies', 'rxjs/Rx', '@angular/router', '@angular/common'], factory) :
    (factory((global['jdb-plg-ui'] = {}),global.ng.core,global.ng.animations,global.ng.forms,global.Observable,global.ng.platformBrowser,global.Cookie,global.Observable,global.ng.router,global.ng.common));
}(this, (function (exports,core,animations,forms,Observable,platformBrowser,ng2Cookies,Rx,router,common) { 'use strict';
